...
SELECT nacionalidad, SUM(salarios) FROM vendedores GROUP BY nacionalidad;
SELECT nacionalidad, AVG(salarios) FROM vendedores GROUP BY nacionalidad;
SELECT nacionalidad, SUM(salarios), ROUND(AVG(salarios)) FROM vendedores GROUP BY nacionalidad;
