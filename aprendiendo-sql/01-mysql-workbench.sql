...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbs-store-01`.`clientes` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbs-store-01`.`vendedores` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NULL,
  `apellido` VARCHAR(45) NULL,
  `email` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbs-store-01`.`pedidos` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_pedidos_clientes`
    ...
    REFERENCES `dbs-store-01`.`clientes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pedidos_vendedores1`
    FOREIGN KEY (`vendedores_id`)
    REFERENCES `dbs-store-01`.`vendedores` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbs-store-01`.`productos` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbs-store-01`.`pedidos_has_productos` (
  ...
  CONSTRAINT `fk_pedidos_has_productos_pedidos1`
    ...
    REFERENCES `dbs-store-01`.`pedidos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pedidos_has_productos_productos1`
    FOREIGN KEY (`productos_id`)
    REFERENCES `dbs-store-01`.`productos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
